...
# Images
export LLMDBENCH_IMAGE_REGISTRY=${LLMDBENCH_IMAGE_REGISTRY:-quay.io}
export LLMDBENCH_IMAGE_REPO=${LLMDBENCH_IMAGE_REPO:-rh_ee_rsaini}
export LLMDBENCH_IMAGE_NAME=${LLMDBENCH_IMAGE_NAME:-llm-d-benchmark}

export LLMDBENCH_IMAGE_TAG=${LLMDBENCH_IMAGE_TAG:-v0.4.1-slo}
...
export LLMDBENCH_GUIDELLM_BACKEND_KWARGS=${LLMDBENCH_GUIDELLM_BACKEND_KWARGS:-""}
